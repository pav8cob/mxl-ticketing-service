...
/**
 * REST controller for managing {@link com.ivert.mxl.tickets.domain.Ticket}.
 */
@RestController
@RequestMapping("/api")
public class TicketResource {
    ...
    private static final String ENTITY_NAME = "mxlTicketingTicket";
    ...
    public ResponseEntity<Ticket> updateTicket(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, ticket.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Ticket> partialUpdateTicket(
        ...
        return ResponseUtil.wrapOrNotFound(result, HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, ticket.getId()));
    }
